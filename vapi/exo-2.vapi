/* exo-2.vapi generated by vapigen, do not modify. */
...
namespace Exo {
	...
	[CCode (cheader_filename = "exo/exo.h")]
	[Compact]
	public class IconChooserModelClass {
	}
	[CCode (cheader_filename = "exo/exo.h")]
	...
	[CCode (cheader_filename = "exo/exo.h")]
	[Compact]
	public class ThumbnailPreviewClass {
	}
	[CCode (cheader_filename = "exo/exo.h")]
	[Compact]
	public class ToolbarsModel {
		...
		public bool add_item (int toolbar_position, int item_position, string id, string type);
	...
	[CCode (cheader_filename = "exo/exo.h")]
	[Compact]
	public class ToolbarsModelClass {
		public weak GLib.Callback add_item;
		public weak GLib.Callback get_item_data;
		public weak GLib.Callback get_item_id;
		public weak GLib.Callback get_item_type;
		...
		public weak GLib.Callback reserved5;
		public weak GLib.Callback reserved6;
		public weak GLib.Callback reserved7;
		public weak GLib.Callback reserved8;
		public weak GLib.Callback toolbar_added;
		public weak GLib.Callback toolbar_changed;
		public weak GLib.Callback toolbar_removed;
	}
	[CCode (cheader_filename = "exo/exo.h")]
	public class TreeView : Gtk.TreeView, Atk.Implementor, Gtk.Buildable, Gtk.Scrollable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
		public TreeView ();
		public bool get_single_click ();
		public uint get_single_click_timeout ();
	...
	[CCode (cheader_filename = "exo/exo.h", cprefix = "EXO_ICON_CHOOSER_", has_type_id = false)]
	public enum IconChooserContext {
		CONTEXT_ACTIONS,
		CONTEXT_ANIMATIONS,
	...
	[CCode (cheader_filename = "exo/exo.h", cprefix = "EXO_ICON_CHOOSER_MODEL_", has_type_id = false)]
	public enum IconChooserModelColumn {
		COLUMN_CONTEXT,
		COLUMN_ICON_NAME,
		N_COLUMNS
	}
	...
	[CCode (cheader_filename = "exo/exo.h", cprefix = "EXO_THUMBNAIL_SIZE_", has_type_id = false)]
	...
	[CCode (cheader_filename = "exo/exo.h")]
	public static void gtk_object_destroy_later (Gtk.Widget object);
	[CCode (cheader_filename = "exo/exo.h")]
